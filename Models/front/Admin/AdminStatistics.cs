...
public class AdminStatistics
{
    ...
    private void LoadStatistics()
    {
        ...
        {
            // Get total students
            Console.WriteLine("Calculating total students...");
            Query stuQuery = new(Tbl.student);
            TotalStudents = stuQuery.Count(conn);
            
            // Get total teachers
            Console.WriteLine("Calculating total teachers...");
            Query teacherQuery = new(Tbl.teacher);
            TotalTeachers = teacherQuery.Count(conn);
            
            // Get total courses
            Console.WriteLine("Calculating total courses...");
            Query courseQuery = new(Tbl.course);
            TotalCourses = courseQuery.Count(conn);
            
            // Get total ratings
            Console.WriteLine("Calculating total ratings...");
            Query ratingQuery = new(Tbl.rating);
            TotalRatings = ratingQuery.Count(conn);
            
            // Get total semesters
            Console.WriteLine("Calculating total semesters...");
            ...
            Console.WriteLine("Calculating monthly registrations...");
            ...
            Console.WriteLine("Calculating semesters by status...");
            ...
            Console.WriteLine("Calculating rating distribution...");
            ...
            Console.WriteLine("Calculating courses by status...");
            ...
            Console.WriteLine("Calculating top upcoming courses...");
            ...
            upcomingCoursesQuery.Output(Field.subject__grade, "sub");
            upcomingCoursesQuery.Output(Field.semester__capacity, "s");
            upcomingCoursesQuery.Output(Field.semester__start_date, "s");
            ...
            upcomingCoursesQuery.OutputTop(10);            
            ...
            {                TopUpcomingCourses.Add(new TopCourse
                {
                    ...
                    Slots = reader.GetInt32(5),
                    StartDate = reader.GetDateTime(6),
                    EnrolledStudents = reader.GetInt32(7)
                });
            });
            
            Console.WriteLine("Calculating top rated courses...");
            ...
            topRatedCoursesQuery.Join(Field.semester__course_id, Field.course__id, "sem", "c");
            topRatedCoursesQuery.WhereInQuery(Field.semester__id, SemesterQuery.GetLatestSemesterIdQuery("sem", "c"), "sem");
            ...
            topRatedCoursesQuery.Output(Field.subject__grade, "sub");
            SemesterQuery.GetRatingAvg(ref topRatedCoursesQuery, "c");
            SemesterQuery.GetParticipantsCount(ref topRatedCoursesQuery, "sem");
            topRatedCoursesQuery.OrderByClause("AVGRATING DESC");
            topRatedCoursesQuery.OutputTop(10);
            ...
            {                TopRatedCourses.Add(new TopCourse
                {
                    ...
                    EnrolledStudents = reader.GetInt32(6)
                });
            });
        });
